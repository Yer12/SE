                            ...
                            while($products = $result->fetch_assoc()){ ?>
                                ...
                                <div class="col-md-5">
                                    <div class="product-details">
                                        <h2 class="product-name"><?php echo $products['product_name']; ?></h2>
                                        <div>
                                        ...
                                        <div>
                                            <h3 class="product-price"><?php echo $products['price']-200; ?> тг<del class="product-old-price">  <?php echo $products['price']; ?>  тг</del></h3>
                                        ...
                                        <ul class="product-links">
                                            ...
                                            <li><a href="#"><?php echo $products['category'] ?></a></li>
                                        </ul>
				...
				<div class="row">
                    ...
                    <?php
                                        ...
                                        if(!$rows){
                                            ...
                                            while($products = $cresult->fetch_assoc()){ ?>
                                                <!-- product -->
                                                    <div class="col-md-3 col-xs-6">
                                                        <div class="product">
                                                            <div class="product-img">
                                                                <img src=<? echo $products['image'] ?> alt="">
                                                                <div class="product-label">
                                                                    <span class="sale">-30%</span>
                                                                </div>
                                                            </div>
                                                            <div class="product-body">
                                                                <p class="product-category">Category: <? echo $products['category'] ?></p>
                                                                <h3 class="product-name"><a href="#"><? echo $products['product_name'] ?></a></h3>
                                                                <h4 class="product-price"><? echo $products['price']-200 ?>тг<del class="product-old-price">  <? echo $products['price'] ?>тг</del></h4>
                                                                <div class="product-rating">
                                                                </div>
